...
function connectTrafficontent() {
    if (typeof trafficontent_vars === 'undefined') {
        console.error('Trafficontent vars not defined');
        return;
    }
    ...
    fetch(trafficontent_vars.ajax_url + "?action=trafficontent_generate_token")
        ...
        .then(tokenData => {
            ...
            return fetch("https://trafficontent.com/api/register_wp_site/", {
                method: "POST",
                credentials: "omit",
                headers: {
...
window.connectTrafficontent = connectTrafficontent;

document.addEventListener('DOMContentLoaded', function () {
    if (typeof trafficontent_vars !== 'undefined') {
        // Any initialization logic that depends on trafficontent_vars can go here if needed
    }
